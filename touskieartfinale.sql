...
--
-- Host: 127.0.0.1:3307
-- Generation Time: May 06, 2023 at 11:45 PM
...
(212, 26, 'YOYOYOYOYOYOYOYO', 'Autre aide', 'YOYOYOYOYOYOYOYOYOYOYOYO', '2023-05-06', NULL, 'Ouvert'),
(217, 34, 'RECRECRECRECREC', 'Evénement', 'RECRECRECRECREC', '2023-05-06', NULL, 'Ouvert');
...
(34, 'Mahmoud', 'Mzoughi', 'mahmoudmzoughi@gmail.com', 'EASY', 12345678, 'imgMe-6449a16cef6bf.png', 'simple utilisateur', 'activé'),
(40, 'User', 'user', 'hmaidi185@gmail.com', '123', 12345678, NULL, 'simple utilisateur', 'activé'),
(41, 'Mahmoud', 'Mzoughi', 'mahmoud.mzoughi@esprit.tn', '123', 12345678, NULL, 'Artiste', 'activé');
...
--
ALTER TABLE `reclamation`
  MODIFY `rec_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=218;

--
-- AUTO_INCREMENT for table `reponses`
--
ALTER TABLE `reponses`
  MODIFY `rep_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=665;
