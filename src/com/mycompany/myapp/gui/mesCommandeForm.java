 ...
 * @author ashre
 */
public class mesCommandeForm extends Form{
    ...
    public mesCommandeForm(Form previous) {
    ...
    private void addGUIs() {
        ...
        ArrayList<Commande> listCommandes = CommandeService.getInstance().getMesCommande(LoginForm.getUserConnected().getId());
    ...
    private Component makeCommandeModel(Commande commande) {
        ...
        idLabel = new Label("id : " + commande.getId_c());
        ...
        statutLabel = new Label("statut : " + commande.getStatue());
        ...
        itemsBtn.addActionListener(action -> {
            ...
            new com.mycompany.myapp.gui.CommandeItemForm(this).show();
        });
        if (commande.isLivraison()) {
            com.mycompany.myapp.gui.LivraisonForm.currentLivraison = null;
            livraisonBtn = new Button("Livraison");
            livraisonBtn.setUIID("buttonMain");
            livraisonBtn.addActionListener(action -> {
                currentCommande = commande;
                new com.mycompany.myapp.gui.LivraisonForm(this).show();
            });
        } else {
            com.mycompany.myapp.gui.LivraisonForm.currentLivraison = new Livraison();
