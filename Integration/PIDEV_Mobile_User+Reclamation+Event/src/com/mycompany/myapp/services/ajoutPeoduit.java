 ...
 * @author Monta
 */
public class ajoutPeoduit {
    
    ArrayList<Produit> products;
     public static ajoutPeoduit instance = null ;
    
      //initilisation connection request 
    private ConnectionRequest req;
       public static boolean resultOk = true;
    public static ajoutPeoduit getInstance() {
        if(instance == null )
            instance = new ajoutPeoduit();
        return instance ;
    }
    public ajoutPeoduit(){
                ...
                try {
                    ...
                    for(Map<String, Object> obj : listOfMaps) {
                       ...
                       float id = Float.parseFloat(obj.get("id").toString());
                        ...
                        String objet = obj.get("codeProduit").toString();
...
//                        re.setDate(dateString);
    ...
    public boolean deleteReclamation(int id ) {
        String url = Statics.BASE_URL +"/produit/deleteProductJSON/"+id;
    ...
    String url = Statics.BASE_URL + "/produit/updateProductJSON/" + rec.getId() + "?Codeproduit=" + rec.getCodeproduit() + "&description=" + rec.getDes();
        req.setUrl(url);
