...
public class ListProduit extends BaseForm {
    public ListProduit(Resources res){
     ...
     super("Newsfeed",BoxLayout.y());
      ...
      Toolbar tb = new Toolbar(true);
        ...
        ArrayList<Produit>list = ajoutPeoduit.getInstance().affichageReclamations();
    ...
    private void updateArrowPosition(Button btn, Label l) {
       ...
       private void addButton(Image img,Produit rec , Resources res) {
        ...
        Label objetTxt = new Label("Nom Produit : "+rec.getCodeproduit(),"NewsTopLine2");
        Label dateTxt = new Label("Description : "+rec.getDes(),"NewsTopLine2");
       Label quantiteTxt = new Label("quantite : "+rec.getQuantite(),"NewsTopLine2");
     //   Label etatTxt = new Label("etat : "+rec.get,"NewsTopLine2" );
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce reclamation ?","Annuler","Oui")) {
                ...
                if(ajoutPeoduit.getInstance().deleteReclamation(rec.getId())) {
        ...
        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(
                ...
                BoxLayout.encloseX( quantiteTxt ,lModifier,lSupprimer)));
