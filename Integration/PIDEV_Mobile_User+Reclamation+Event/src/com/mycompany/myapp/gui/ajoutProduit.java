     ...
     super("Newsfeed",BoxLayout.y());
      ...
      Toolbar tb = new Toolbar(true);
        ...
        addOrientationListener(e -> {
          ...
          TextField objet = new TextField("", "entrer Nom Produit!!");
        objet.setUIID("TextFieldBlack");
        addStringValue("Codeproduit",objet);
...
//        
//        TextField QuantiteM = new TextField("", "entrer QuantiteM!!");
//        description.setUIID("TextFieldBlack");
//        addStringValue("QuantiteM",QuantiteM);
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if(objet.getText().equals("") || description.getText().equals("")) {
                    ...
                    Produit r = new Produit(String.valueOf(objet.getText()
                                  ).toString(),
                    ...
                    ajoutPeoduit.getInstance().ajoutReclamation(r);
